...
|`<uni-collapse-item>`|`uni-collapse-item`, `<uni-collapse-item>`, `UniCollapseItem`, `<UniCollapseItem>`|uni-ui 折叠面板项。更多信息查看 <https://uniapp.dcloud.net.cn/component/uniui/uni-collapse>。|
...
|`<uni-fab>`|`uni-fab`, `<uni-fab>`, `UniFab`, `<UniFab>`|uni-ui 悬浮按钮。更多信息查看 <https://uniapp.dcloud.net.cn/component/uniui/uni-fab>。|
|`<uni-fav>`|`uni-fav`, `<uni-fav>`, `UniFav`, `<UniFav>`|uni-ui 收藏按钮。更多信息查看 <https://uniapp.dcloud.net.cn/component/uniui/uni-fav>。|
|`<uni-file-picker>`|`uni-file-picker`, `<uni-file-picker>`, `UniFilePicker`, `<UniFilePicker>`|uni-ui 文件选择上传。更多信息查看 <https://uniapp.dcloud.net.cn/component/uniui/uni-file-picker>。|
|`<uni-forms>`|`uni-forms`, `<uni-forms>`, `UniForms`, `<UniForms>`|uni-ui 表单。更多信息查看 <https://uniapp.dcloud.net.cn/component/uniui/uni-forms>。|
|`<uni-forms-item>`|`uni-forms-item`, `<uni-forms-item>`, `UniFormsItem`, `<UniFormsItem>`|uni-ui 表单项。更多信息查看 <https://uniapp.dcloud.net.cn/component/uniui/uni-forms>。|
|`<uni-goods-nav>`|`uni-goods-nav`, `<uni-goods-nav>`, `UniGoodsNav`, `<UniGoodsNav>`|uni-ui 商品导航。更多信息查看 <https://uniapp.dcloud.net.cn/component/uniui/uni-goods-nav>。|
|`<uni-grid>`|`uni-grid`, `<uni-grid>`, `UniGrid`, `<UniGrid>`|uni-ui 宫格。更多信息查看 <https://uniapp.dcloud.net.cn/component/uniui/uni-grid>。|
|`<uni-grid-item>`|`uni-grid-item`, `<uni-grid-item>`, `UniGridItem`, `<UniGridItem>`|uni-ui 宫格项。更多信息查看 <https://uniapp.dcloud.net.cn/component/uniui/uni-grid>。|
|`<uni-group>`|`uni-group`, `<uni-group>`, `UniGroup`, `<UniGroup>`|uni-ui 分组。更多信息查看 <https://uniapp.dcloud.net.cn/component/uniui/uni-group>。|
|`<uni-icons>`|`uni-icons`, `<uni-icons>`, `UniIcons`, `<UniIcons>`|uni-ui 图标。更多信息查看 <https://uniapp.dcloud.net.cn/component/uniui/uni-icons>。|
|`<uni-indexed-list>`|`uni-indexed-list`, `<uni-indexed-list>`, `UniIndexedList`, `<UniIndexedList>`|uni-ui 索引列表。更多信息查看 <https://uniapp.dcloud.net.cn/component/uniui/uni-indexed-list>。|
|`<uni-link>`|`uni-link`, `<uni-link>`, `UniLink`, `<UniLink>`|uni-ui 超链接。更多信息查看 <https://uniapp.dcloud.net.cn/component/uniui/uni-link>。|
|`<uni-list>`|`uni-list`, `<uni-list>`, `UniList`, `<UniList>`|uni-ui 列表。更多信息查看 <https://uniapp.dcloud.net.cn/component/uniui/uni-list>。|
|`<uni-list-chat>`|`uni-list-chat`, `<uni-list-chat>`, `UniListChat`, `<UniListChat>`|uni-ui 聊天列表项。更多信息查看 <https://uniapp.dcloud.net.cn/component/uniui/uni-list>。|
|`<uni-list-item>`|`uni-list-item`, `<uni-list-item>`, `UniListItem`, `<UniListItem>`|uni-ui 列表项。更多信息查看 <https://uniapp.dcloud.net.cn/component/uniui/uni-list>。|
|`<uni-load-more>`|`uni-load-more`, `<uni-load-more>`, `UniLoadMore`, `<UniLoadMore>`|uni-ui 加载更多。更多信息查看 <https://uniapp.dcloud.net.cn/component/uniui/uni-load-more>。|
|`<uni-nav-bar>`|`uni-nav-bar`, `<uni-nav-bar>`, `UniNavBar`, `<UniNavBar>`|uni-ui 导航栏。更多信息查看 <https://uniapp.dcloud.net.cn/component/uniui/uni-nav-bar>。|
|`<uni-notice-bar>`|`uni-notice-bar`, `<uni-notice-bar>`, `UniNoticeBar`, `<UniNoticeBar>`|uni-ui 通告栏。更多信息查看 <https://uniapp.dcloud.net.cn/component/uniui/uni-notice-bar>。|
|`<uni-number-box>`|`uni-number-box`, `<uni-number-box>`, `UniNumberBox`, `<UniNumberBox>`|uni-ui 数字输入框。更多信息查看 <https://uniapp.dcloud.net.cn/component/uniui/uni-number-box>。|
|`<uni-pagination>`|`uni-pagination`, `<uni-pagination>`, `UniPagination`, `<UniPagination>`|uni-ui 分页器。更多信息查看 <https://uniapp.dcloud.net.cn/component/uniui/uni-pagination>。|
|`<uni-popup>`|`uni-popup`, `<uni-popup>`, `UniPopup`, `<UniPopup>`|uni-ui 弹出层。更多信息查看 <https://uniapp.dcloud.net.cn/component/uniui/uni-popup>。|
|`<uni-popup-dialog>`|`uni-popup-dialog`, `<uni-popup-dialog>`, `UniPopupDialog`, `<UniPopupDialog>`|uni-ui 弹出层对话框。更多信息查看 <https://uniapp.dcloud.net.cn/component/uniui/uni-popup>。|
|`<uni-popup-message>`|`uni-popup-message`, `<uni-popup-message>`, `UniPopupMessage`, `<UniPopupMessage>`|uni-ui 弹出层提示信息。更多信息查看 <https://uniapp.dcloud.net.cn/component/uniui/uni-popup>。|
|`<uni-popup-share>`|`uni-popup-share`, `<uni-popup-share>`, `UniPopupShare`, `<UniPopupShare>`|uni-ui 弹出层分享。更多信息查看 <https://uniapp.dcloud.net.cn/component/uniui/uni-popup>。|
...
|`<uni-swipe-action>`|`uni-swipe-action`, `<uni-swipe-action>`, `UniSwipeAction`, `<UniSwipeAction>`|uni-ui 滑动操作。更多信息查看 <https://uniapp.dcloud.net.cn/component/uniui/uni-swipe-action>。|
|`<uni-swipe-action-item>`|`uni-swipe-action-item`, `<uni-swipe-action-item>`, `UniSwipeActionItem`, `<UniSwipeActionItem>`|uni-ui 滑动操作项。更多信息查看 <https://uniapp.dcloud.net.cn/component/uniui/uni-swipe-action>。|
|`<uni-swiper-dot>`|`uni-swiper-dot`, `<uni-swiper-dot>`, `UniSwiperDot`, `<UniSwiperDot>`|uni-ui 轮播图指示点。更多信息查看 <https://uniapp.dcloud.net.cn/component/uniui/uni-swiper-dot>。|
|`<uni-table>`|`uni-table`, `<uni-table>`, `UniTable`, `<UniTable>`|uni-table 表格。更多信息查看 <https://uniapp.dcloud.net.cn/component/uniui/uni-table>。|
|`<uni-tr>`|`uni-tr`, `<uni-tr>`, `UniTr`, `<UniTr>`|uni-table 表格。更多信息查看 <https://uniapp.dcloud.net.cn/component/uniui/uni-table>。|
|`<uni-th>`|`uni-th`, `<uni-th>`, `UniTh`, `<UniTh>`|uni-table 表格。更多信息查看 <https://uniapp.dcloud.net.cn/component/uniui/uni-table>。|
